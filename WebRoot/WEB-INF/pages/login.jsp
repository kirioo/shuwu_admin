...
<html>
  <head>
	...
	<style type="text/css">
		...
		#loginbox .main_input_box input{ height:42px; border:0px; display:inline-block; width:75%; line-height:42px;  margin-bottom:3px;padding-left:6px;color:#333}
  	...
  	<div id="loginbox">
		<form id="loginform" action="" method="post">
			...
			<div class="control-group">
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><i class="fa fa-lock"></i></span><input type="password" id="password" maxlength="20" autocomplete="off" placeholder="请输入密码...">
					</div>
				</div>
			</div>
