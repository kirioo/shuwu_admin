		...
		<div class="content">
			...
			<div class="cnt">
				<div style="padding:10px;">
					<input type="text"  id="date" onFocus="WdatePicker({onpicking:changeDate,isShowWeek:true})" class="Wdate"/>
<!-- 				onfocus="WdatePicker({,onpicked:funccc,errDealMode:3})"/>	 -->
				</div>
	...
	<script>
		...
		function loadData(year){
			$.ajax({
				type:"post",
				url:"http://localhost/malimao_admin/admin/funds/groupWeeks",
				data:{year:year},
