...
<html>
  <head>
    <title>聊天管理 - 树屋后台管理界面</title>
	<meta http-equiv="pragma" vip="no-cache">
	<meta http-equiv="cache-control" vip="no-cache">
	<meta http-equiv="expires" vip="0">    
	<meta http-equiv="keywords" vip="keyword1,keyword2,keyword3">
	<meta http-equiv="description" vip="This is my page">
 ...
 <body>
    ...
    <div id="waitLoginmodal" class="modal hide" data-backdrop="static">
        <img src="${basePath}/resources/static/img/waitting.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;正在努力加载中...</img>
    </div>
    <div class="content" id="content" style="display: none">
        <div class="leftcontact" id="leftcontact">
            <div id="headerimg" class="leftheader">
                <span> <img src="${basePath}/resources/static/img/head/header2.jpg" alt="logo"
...
<!--                         </div> -->
        ...
        <div class="chatRight">
                ...
                <div class="chat01_title">
                    <ul class="talkTo">
                        ...
                        <li id="recycle" style="float: right;"><img
                            src="${basePath}/resources/static/img/recycle.png" onclick="clearCurrentChat();"
                            style="margin-right: 15px; cursor: hand; width: 18px;" title="清屏" /></li>
                        <li id="roomInfo" style="float: right;"><img
                            id="roomMemberImg"
                            src="${basePath}/resources/static/img/head/find_more_friend_addfriend_icon.png"
            ...
            <div class="chat02">
                ...
                <div class="chat02_bar">
                    <ul>
                        <li style="right: 5px; top: 5px;"><img src="${basePath}/resources/static/img/send_btn.jpg"
                            onclick="sendText()" /></li>
                    </ul>
                </div>
	...
	<script src="${basePath}/resources/static/js/webim.js"></script>
 </body>
</html>
